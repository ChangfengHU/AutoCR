...
class AIServiceManager {
    ...
    fun getPrimaryService(): AIService? {
        ...
        return when (settings.primaryAIService) {
            AIServiceType.DEEPSEEK -> services.find { it is com.vyibc.autocrplugin.service.impl.DeepSeekService }
            AIServiceType.TONGYI -> services.find { it is com.vyibc.autocrplugin.service.impl.TongyiService }
            AIServiceType.GEMINI -> services.find { it is com.vyibc.autocrplugin.service.impl.GeminiService }
